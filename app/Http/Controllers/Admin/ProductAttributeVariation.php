...
class ProductAttributeVariation extends Controller
{
   ...
   if($cheapest_attr_variation != null){
           $product->update([
                'quantity'=>$quantity,
                'price'=>$cheapest_attr_variation->price,
                'sale_price'=>calculateDiscount($cheapest_attr_variation->price,$cheapest_attr_variation->percent_sale),
            ...
            alert()->success('ویرایش اطلاعات با موفقیت انجام شد','باتشکر');
