...
class AttributeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $attributes = Attribute::orderby('priority')->paginate(20);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.attributes.index',['page'=>$currentPage]);
    }
    ...
    public function attributes_values_add_or_update(Request $request)
    {
        ...
        if (!$attribute_value == null) {
            ...
            $attribute_value->update([
                ...
                'name_en' => $request->attribute_value_en,
                'image' => $image,
            ]);
  ...
  public function priority_show_update(Request $request)
    {
        ...
        $option_ex = ProductOption::where('value',$value->id)->exists();
        if($option_ex){
            $options = ProductOption::where('value',$value->id)->get();
    ...
    public function updateoption_value()
    {
    ...
    {
        $attr_groups = AttributeGroup::orderBy('name')->paginate(20);
