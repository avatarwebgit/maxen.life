...
class ProductImageController extends Controller
{
    public function upload($primaryImage, $images)
    {
        ...
        $fileNamePrimaryImage = uploadImage($primaryImage,env('PRODUCT_IMAGES_UPLOAD_PATH'));
        $fileNameImages = [];
        if ($images!=null){
            foreach ($images as $image) {
                $fileNameImage = uploadImage($primaryImage,env('PRODUCT_IMAGES_UPLOAD_PATH'));
    ...
    public function add(Request $request, Product $product)
    {
        ...
        $request->validate([
            ...
            'images.*' => 'nullable|mimes:jpg,jpeg,png,svg,gif',
        ]);
