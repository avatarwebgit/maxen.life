...
class ArticleController extends Controller
{
    ...
    {
        $categories = ArticleCategoriy::all();
        $product_categories = Category::where('is_active', 1)->get();
        return view('admin.articles.create', compact('categories', 'product_categories'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'shortDescription' => 'nullable|max:100',
        ...
        try {
            ...
            //category_product
            $product_categories = $request->product_category_id;
            if (!empty($product_categories)) {
                foreach ($product_categories as $product_category) {
                    $article->ProductCategories()->attach($product_category);
                }
            }
            DB::commit();
        } catch (\Exception $ex) {
    ...
    public function edit(Article $article)
    {
        $categories = ArticleCategoriy::all();
        $product_categories = Category::where('is_active', 1)->get();
        return view('admin.articles.edit', compact('article', 'categories', 'product_categories'));
    }
