...
class MelletGateWay extends Payment
{
    ...
    public function __construct($amount, $charge_wallet = null)
    {
        ...
        if ($charge_wallet === 'yes') {
            ...
            if (session()->exists('invoice')){
                $this->callBackUrl = route('home.mellat_verify',['invoice'=>true]);
            }else{
    ...
    public function peyment($addressId = null, $order_id = null)
    {
                    ...
                    if ($this->charge_wallet == null) {
                        if ($order_id != null) {
                            ...
                            Transaction::create([
                                ...
                                'description' => 'پرداخت مبلغ پیش فاکتور',
                            ]);
                            return [1];
                        } else {
    ...
    public function showEndForm()
    {
        ...
        ?>
        <div
            style="text-align: center;margin:100px auto;width:400px;height: 150px;background-color: #f0f7ff; font-family:Tahoma, Geneva, sans-serif; border:1px solid #c5e2ff; color:#107df6; font-size:11px; line-height:20px; padding-top:3px; padding:5px 14px; -webkit-border-radius:8px; -moz-border-radius:8px; border-radius:8px; text-align:right">
    ...
    function CheckStatus($ecode)
    {
        ...
        switch ($ecode) {
            ...
            case 16:
                ...
                break;
            case 17:
                $tmess = "عملیات پرداخت ناموفق بود";
                break;
            case 18:
