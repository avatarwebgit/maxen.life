    ...
    var e, t = {
        604: (e, t, n) => {
            ...
            function s(e, t) {
                ...
                for (var o in e) if (o.substring(o.length - n.length, o.length) === n) return e[o](t);
                return !1
            }
            ...
            var f = document.querySelector(".js-lcc-modal-alert"), v = document.querySelector(".js-lcc-modal-settings"),
                ...
                b = document.querySelector(".js-lcc-backdrop"), _ = document.getElementById("lcc-checkbox-analytics"),
                y = document.getElementById("lcc-checkbox-marketing"), g = f.dataset.cookieKey || "__cookie_consent",
                p = f.dataset.cookieValueAnalytics || "2", E = f.dataset.cookieValueMarketing || "3",
                k = f.dataset.cookieValueNone || "false", N = f.dataset.cookieValueBoth || "true",
                I = f.dataset.cookieExpirationDays || "365", w = f.dataset.gtmEvent || "pageview",
            ...
            !function () {
                if ("undefined" != typeof window) {
                    var n = Array.prototype.slice, o = Element.prototype.matches || Element.prototype.msMatchesSelector,
                        ...
                        r = function () {
                            ...
                            return e(r, [{
                                ...
                                key: "_onMutation", value: function (e, t) {
                            ...
                            return e(i, [{
                                key: "setInert", value: function (e, t) {
                                    if (t) {
                                        ...
                                        var n = new r(e, this);
                                        if (e.setAttribute("inert", ""), this._inertRoots.set(e, n), !this._document.body.contains(e)) for (var o = e.parentNode; o;) 11 === o.nodeType && u(o), o = o.parentNode
                                    } else {
                                        if (!this._inertRoots.has(e)) return;
                                ...
                                key: "_watchForInert", value: function (e, t) {
                                    var i = this;
                                    e.forEach((function (e) {
                                        switch (e.type) {
                                            case"childList":
                                            ...
                                            case"attributes":
                                                ...
                                                var t = e.target, r = t.hasAttribute("inert");
                                                i.setInert(t, r)
                                        }
                                    }), this)
                                }
                ...
                function c(e, t, n) {
                    if (e.nodeType == Node.ELEMENT_NODE) {
                        ...
                        if ("slot" == o.localName) {
                            for (var d = o, u = d.assignedNodes ? d.assignedNodes({flatten: !0}) : [], l = 0; l < u.length; l++) c(u[l], t, n);
                            return
                        }
                    }
