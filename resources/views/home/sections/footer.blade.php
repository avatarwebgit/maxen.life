 ...
 @enderror
    ...
    <div  class="copyright">
        <div class="text-center d-flex align-items-center flex-column flex-lg-row justify-content-around">
            <div>
                <ul class="d-flex justify-content-center align-items-center flex-row-reverse icon_fix">
                    <li class="fmr-2 " >
                        <a href="{{$setting->linkedin}}">
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 47 47">
