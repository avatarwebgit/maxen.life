                                ...
                                @foreach($categories as $cat)
                                    <li class="over-hidden">
                                        <a href="{{ route('home.product_categories',['category'=>$cat->alias]) }}"
                                           data-dsn="parallax" target="_blank"
                                           rel="nofollow">{{ app()->getLocale() == 'fa' ?  $cat->name  : $cat->name_en  }}
                                            ({{$cat->Products->count()}})</a>
                                    </li>
                                @endforeach
                        ...
                        <div class="footer-social mt-3 p-relative">
                            <ul>
                                ...
                                @foreach($pages_g[0] as $page)
                                    ...
                                    <li class="over-hidden">
                                        <a href="{{ route('home.page',['page'=>$page->alias]) }}" data-dsn="parallax"
                                           target="_blank"
                                           rel="nofollow">{{ app()->getLocale() == 'fa' ? $page->title : $page->title_en }}</a>
                                    </li>
                        ...
                        <div class="footer-social mt-3 p-relative">
                            <ul>
                                @foreach($pages_g[1] as $page)
                                    ...
                                    @if($page->id == 6)
                                        <li class="over-hidden">
                                            <a href="{{ route('home.contact') }}" data-dsn="parallax" target="_blank"
                                               rel="nofollow">{{ app()->getLocale() == 'fa' ? $page->title : $page->title_en }}</a>
                                        </li>
                                ...
                                @endforeach
                                <li class="over-hidden">
                                    <a href="https://maxen.life/DL/MAXEN-CATALOG.pdf" data-dsn="parallax"
                                       target="_blank" rel="nofollow">{{ __('Catalogue') }}</a>
                                </li>
                    ...
                    <li class="mr-2">
                        <a href="{{$setting->linkedin}}">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100"
                                 viewBox="0 0 50 50" style="width:36px">
                                <path
                    ...
                    <li class="mr-2">
                        <a href="{{$setting->youtube}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                                ...
                                <path id="Path_177" data-name="Path 177" d="M596.5,65.707l10.138-5.854L596.5,54Z"
                    ...
                    <li class="mr-2">
                        <a href="{{$setting->twitter}}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 version="1.1" width="100" height="100" viewBox="0 0 256 256" xml:space="preserve">
...
<defs>
                    ...
                    <li class="mr-2">
                        <a href="{{$setting->aparat}}">
                            <svg style="background: #000000;border-radius: 50%" width="45px" fill="#ffffff"
                                 viewBox="-2.4 -2.4 28.80 28.80" role="img" xmlns="http://www.w3.org/2000/svg"
                                 stroke="#ffffff" stroke-width="0.00024000000000000003" transform="rotate(0)">
