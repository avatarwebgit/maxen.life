...
@section('style')
    ...
    <style>
        ...
        .product-form-c:hover{
            background-color: #000;
            border-color: #fff;
            color: #fff;
            border: 1px solid;
        }
        .product-form-c:hover svg path {
            fill: white;
            color:white
        }
    </style>
        ...
        <section class="product-section section-margin">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-5 order-lg-1 order-2">
                        <div class="product-title text-center">
                            <h4 class="text-title-1"
                                style="font-weight:500">{{app()->getLocale() == 'fa' ? $product->name : $product->name_en}}


                            </h4>
                            <h1 class="text-title-2"
                                style="font-weight:800">{{app()->getLocale() == 'fa' ? $product->title_1 : $product->title_1_en}}</h1>
                            <h2 class="text-title-3"
                                style="font-weight:500">{{app()->getLocale() == 'fa' ? $product->title_2 : $product->title_2_en}}</h2>
                        </div>
                        ...
                        <div class="card-footer dir-rtl">
                                ...
                                <a href="{{$product->ar}}" class="product-form-c"
                                   style="margin:0 auto;display: flex;justify-content: space-around;padding:0 20px"
                                   class="btn-product btn-cart text-normal ls-normal font-weight-semi-bold">
                                    <svg fill="#000000" height="30px" width="30px" version="1.1" id="Capa_1"
                                         ...
                                         viewBox="0 0 611.999 611.999" xml:space="preserve"><g
                                ...
                                @if($item->attribute_id == 2 or $item->attribute_id == 46)
                                    ...
                                    @if($item->attributeValues($item->value,$item->attribute_id)->image != null)
                                        <img class="product-brand"
                                             src="{{imageExist(env('ATTR_UPLOAD_PATH'),$item->attributeValues($item->value,$item->attribute_id)->image)}}">
                    ...
                    <div class="col-lg-6 order-lg-2 order-1">
                        <div class="row">
                            ...
                            <div class="col-lg-2 d-none d-md-block swiper">
                                <div
                                    class="product-small-thumb small-thumb-wrapper swiper-wrapper justify-content-md-between justify-content-lg-normal small-thumb-style-two">
                                    @foreach($AllProductImages as $key => $image)
                            ...
                            <div class="col-lg-12 d-block d-md-none swiper">
                                <div
                                    class="product-small-thumb small-thumb-wrapper  justify-content-md-between justify-content-lg-normal small-thumb-style-two">
                                    <div class="row p-4">
                                        @foreach($AllProductImages as $key => $image)
                                            @if($image!=null and $key+1 <= 3)
                                                <div class="small-thumb-img w-100 col-3 ">
                                                    <img class="w-100" data-id="{{$key+1}}"
                                                         onclick="checkActiveSelectItem(this)"
                                                         src="{{ imageExist(env('PRODUCT_IMAGES_UPLOAD_PATH'),$image) }}"
                                                    >
                                                </div>
                                            @endif
                    ...
                    <div
                        class="col-12 d-none  col-lg-1 order-3 d-lg-flex justify-content-center align-items-start flex-lg-column">
                        ...
                        <div class="mb-2 w-100 d-flex justify-content-center align-items-center">
                            <a href="{{$setting->support_link}}" class="d-flex flex-column text-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="73.755"
                                     viewBox="0 0 82.545 73.755">
                                    <path id="Path_1357" data-name="Path 1357"
                                          d="M69.482,34.077a33.577,33.577,0,1,0-67.154,0" transform="translate(5.508)"
                                          fill="none" stroke="#000" stroke-miterlimit="10" stroke-width="1"/>
                                    <path id="Path_1358" data-name="Path 1358"
                                          d="M12.3,44.054A33.577,33.577,0,0,0,45.881,10.477"
                                          transform="translate(29.109 23.603)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                    <path id="Path_1359" data-name="Path 1359"
                                          d="M21.833,24.387a5.6,5.6,0,1,0-5.6,5.6A5.6,5.6,0,0,0,21.833,24.387Z"
                                          transform="translate(25.177 43.27)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                    <line id="Line_57" data-name="Line 57" x2="15.109" transform="translate(0 34.078)"
                                          fill="none" stroke="#000" stroke-miterlimit="10" stroke-width="1"/>
                                    <line id="Line_58" data-name="Line 58" x2="15.109"
                                          transform="translate(67.436 34.078)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                    <path id="Path_1360" data-name="Path 1360"
                                          d="M46.545,25.036A20.146,20.146,0,1,0,26.4,45.183,20.147,20.147,0,0,0,46.545,25.036Z"
                                          transform="translate(14.793 10.381)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                </svg>
                        ...
                        <div class="mb-2 w-100 d-flex justify-content-center align-items-center">
                            <a href="{{$setting->login_link}}" class="d-flex flex-column text-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="58.176"
                                     viewBox="0 0 68.155 58.176">
                                    <path id="Path_1361" data-name="Path 1361"
                                          d="M29.351,55.243,19.344,45.237,9.2,55.378"
                                          transform="translate(14.576 -16.229)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                    <path id="Path_1362" data-name="Path 1362"
                                          d="M59.607,46.6A33.579,33.579,0,0,0,12.119,94.09"
                                          transform="translate(-1.787 -36.267)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                    <path id="Path_1363" data-name="Path 1363"
                                          d="M19.317,87.177a33.58,33.58,0,0,0,0-47.488"
                                          transform="translate(38.503 -29.354)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                    <path id="Path_1364" data-name="Path 1364"
                                          d="M46.5,61.3A20.146,20.146,0,1,0,26.355,81.45,20.147,20.147,0,0,0,46.5,61.3Z"
                                          transform="translate(7.497 -25.886)" fill="none" stroke="#000"
                                          stroke-miterlimit="10" stroke-width="1"/>
                                </svg>
                    ...
                    <div class="container-fluid section-attributes">
                        ...
                        @if(count($product_attributes)>0)
                            @foreach($attribute_Groups as $key=>$attribute_Group)
                                <div style="padding-left:0" onclick="open_tab_group(this,{{ $attribute_Group->id }})"
                                     class="col-12 margin-0 row product-attribute">

                                    <div style="padding-right:0"
                                         class="col-12 d-flex d-lg-block justify-content-between align-items-start col-lg-2">
                                    ...
                                    <div style="padding-left:0" id="attr_group_table_{{ $attribute_Group->id }}"
                                         class="col-12 col-lg-10 attr_children {{ $key==0 ? '' : 'd-none' }}">
                                        <ul>
                                            @foreach($product_attributes as  $key_2 => $product_attribute)
                                                @if($product_attribute->attribute->group_id==$attribute_Group->id)
                                                    <li class="d-flex">
                                                        <span
                                                            class="title-attr">{{ app()->getLocale() == 'fa' ? $product_attribute->attribute->name :  $product_attribute->attribute->name_en}}</span>
                                                        <span>       @php
                                    ...
                                    <div style="margin-right:auto;top:{{$key==0 ? '10% !important' : ''}}"
                                         class=" d-none {{$key==0 ? 'position-arrow' : ''}}  custom-arrow d-lg-flex justify-content-center align-items-center">
                                        <img class="arrow_icon left_icon {{ $key==0 ? 'd-none' : '' }}"
                                             src="{{ asset('home/img/left.png') }}">
                                        <img class="arrow_icon down_icon {{ $key==0 ? '' : 'd-none' }}"
                                             src="{{ asset('home/img/down.png') }}">
