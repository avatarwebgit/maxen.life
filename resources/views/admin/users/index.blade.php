            ...
            <div class="row d-lg-flex justify-content-between align-items-center mb-3">
                ...
                <div class="col-md-6 col-12">
                    <div class="d-lg-flex justify-content-end align-items-center">
                        ...
                        <div>
                            <a title="افزودن کاربر جدید" href="{{ route('admin.user.create') }}" class="btn btn-info btn-sm">افزودن</a>
                        </div>
                        @if($has_request_change_role)
                            <a title="برای تغییر کاربری درخواست جدید دارید" href="{{ route('admin.user.change_role.index') }}" class="btn btn-danger btn-sm mr-3">درخواست جدید</a>
                        @endif
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-bordered text-center table-striped">
                                ...
                                @foreach($users as $key=>$item)
                                    <tr class="{{ $item->is_active==0 ? 'bg-danger text-white' : ''  }}">
                                        ...
                                        <td>
                                            {{ isset($item->Role->display_name) ? $item->Role->display_name : '-' }}
                                        </td>
                                        <td>
