...
@section('script')
    <script>
        ...
        $('#attributeForm').on('submit',function (e) {
            ...
            let attribute_value_en = $('#attribute_value_en').val();
        ...
        function update_attribute_value(attribute_value_id,attribute_value,attribute_value_en) {
            ...
            $('#attribute_value').val(attribute_value);
             $('#attribute_value_en').val(attribute_value_en);
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="d-flex flex-column text-center flex-md-row justify-content-md-between mb-4">
                ...
                <div>
                    ...
                    <a class="btn btn-sm btn-outline-dark" href="{{ route('admin.attributes.index',['page'=>request()->session()->get('current_page', 1)]) }}">
                        بازگشت
                        ...
                        <tr>
                            ...
                            <th>
                               @if($value->id!=346 and $value->id!=217)
                                ...
                                @endif
                                <button onclick="update_attribute_value({{ $value->id }},'{{ $value->name }}','{{$value->name_en}}')" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#add_attribute_values">
