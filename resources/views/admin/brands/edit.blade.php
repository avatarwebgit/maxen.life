                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                       ...
                       <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="alias" name="alias" type="text" value="{{ $brand->alias }}" >
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" id="meta_des" name="meta_des" type="text" value="{{ $brand->meta_des }}" >
                    </div>
                </div>
