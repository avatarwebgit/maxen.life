...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <div class="tab-pane fade show active" id="fa" role="tabpanel" aria-labelledby="fa-tab">
      <div class="form-row">
                        ...
                        <textarea class="form-control" id="text" name="title" type="text">{{ old('title') }}</textarea>
                    </div>
        ...
        <div class="tab-pane fade " id="en" role="tabpanel" aria-labelledby="en-tab">
               <div class="form-row">
                           ...
                           <div class="form-group col-12">
                        <label for="text">عنوان</label>
                        <textarea class="form-control" id="text" name="title_en" type="text">{{ old('title_en') }}</textarea>
                    </div>
