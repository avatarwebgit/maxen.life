        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <form action="{{ route('admin.sliders.update' , ['slider' => $slider]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="image_2">انتخاب تصویر در حالت موبایل</label>
                        <div class="custom-file">
                            <input type="file" name="image_2" class="custom-file-input" id="image_2">
                            <label class="custom-file-label" for="image_2"> انتخاب فایل </label>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="priority" name="priority" type="text" value="{{ $slider->priority }}">
                    </div>
                    <div class="form-group col-md-6">
