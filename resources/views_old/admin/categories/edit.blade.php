            ...
            <form action="{{ route('admin.categories.update',['category'=>$category->id]) }}" method="POST"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <label title="تغییرات قیمت برای تمامی محصولات مربوط به این دسته بندی اعمال میگردد"
                               for="price_modify">تغییرات قیمت(%)</label>
                        <input title="تغییرات قیمت برای تمامی محصولات مربوط به این دسته بندی اعمال میگردد"
                               class="form-control" id="price_modify" name="price_modify" type="number" min="-100"
                               max="100" value="0">
                    </div>
                    <div class="form-group col-12">
                        <div class="alert alert-info d-flex justify-content-between">
                            <label for="option_price_modify" class="m-0">اعمال تغییرات قیمت برای اقلام افزوده کالا ها</label>
                            <input  type="checkbox" id="option_price_modify" name="option_price_modify">
                        </div>
                    </div>
                    <div class="col-12">
                        <hr>
