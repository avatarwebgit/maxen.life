...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-xl-10 col-lg-7">
            <div class="card">
                <div class="row card-body">
                    <div class="col-12">
                        <h5 class="mt-2">
                            بازه زمانی دلخواه خود را برای نمایش تعداد بازدید انتخاب نمایید
                            <hr>
                        </h5>
                        <div class="d-flex align-center flex-column text-center justify-content-end flex-md-row mt-4 mb-4">
                            @csrf
                            <div class="form-group ml-3 mb-0">
                                <div class="input-group">
                                    <div class="input-group-prepend order-2">
                                                    <span class="input-group-text" id="start_insurance_date">
                                                        <i class="fas fa-clock"></i>
                                                    </span>
                                    </div>
                                    <input placeholder="تاریخ شروع" type="text"
                                           class="form-control form-control-sm" id="insurance_start_input"
                            ...
                            <div class="form-group ml-3 mb-0">
                                <div class="input-group">
                                    <div class="input-group-prepend order-2">
                                                    <span class="input-group-text" id="end_insurance_date">
                                                        <i class="fas fa-clock"></i>
                                                    </span>
                                    </div>
                                    <input placeholder="تاریخ پایان" type="text"
                                           class="form-control form-control-sm" id="insurance_end_input"
                            ...
                            <button class="btn btn-info btn-sm" onclick="insuranceResult()">Show</button>
                        </div>
                    </div>
                    <div class="col-12">
                        <div id="insuranceResult" class="alert alert-info text-center">
                            -
                        </div>
                    </div>
                </div>
