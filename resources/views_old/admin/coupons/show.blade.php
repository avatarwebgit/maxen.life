                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        @if($coupon->user_id==null)
                            <input disabled class="form-control" type="text" value="همه کاربران">
                        @else
                            <input disabled class="form-control" type="text" value="{{ $coupon->User->first_name.' '.$coupon->User->last_name }}">
                        @endif
                    </div>
                </div>
