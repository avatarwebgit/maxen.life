    ...
    <li class="nav-item">
        ...
        <div id="collapseMainPageSetting" class="collapse {{ $show }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ request()->is('admin-panel/management/sections*') ? 'bg-active' : '' }}" href="{{ route('admin.sections.index') }}">sections</a>
                           <a class="collapse-item {{ request()->is('admin-panel/management/setting/title*') ? 'bg-active' : '' }}" href="{{ route('admin.setting.title') }}">تنظیمات عنوان</a>
            </div>
        </div>
    </li>
