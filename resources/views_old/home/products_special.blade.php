    ...
    <script>
        ...
        function loadMoreData(current_page) {
            ...
            if(current_page > total){
                ...
                $.ajax(
                    {
                        url: "{{ route('home.products.special') }}",
                        type: "get",
                        data: {
                            page: current_page,
                        },
        ...
        <div class="page-content mb-10">
            <div class="container">
                <!-- Start of Shop Banner -->
                 @if($setting->special_page_banner!=null)
                <!-- Start of Shop Banner -->

                 <div class="shop-default-banner banner d-flex align-items-center mb-5 br-xs"
                     style="    height: 270px;">

                    <img  src="{{ imageExist(env('BANNER_PAGES_UPLOAD_PATH'),$setting->special_page_banner) }}">
                ...
                @endif
                    ...
                    <img class="map-link-img" src="{{asset('home/images/arrow_rtl.png')}}"> <a class="map-link" >فروش ویژه</a>
                </div>
                <!-- End of Shop Banner -->
